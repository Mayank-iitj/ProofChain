...
import { 
  ...
  LineChart as ChartLineData01Icon,
...
const renderIcon = (IconCmp, size) =>
  isValidElement(IconCmp) ? IconCmp : <IconCmp size={size} strokeWidth={1.8} />;
                  ...
                  {open === 'model' ? (
                    <>
                      ...
                      <span className="prompt-bar__row-check" data-on={row.key === model?.key ? '' : undefined}>
                        <Tick02Icon size={13} strokeWidth={2.5} />
                      </span>
                    </>
                  ) : null}
                </button>
          ...
          <div className="prompt-bar__chips">
            {attachments.map((file, i) => (
              <span key={`${file}-${i}`} className="prompt-bar__chip">
                <File02Icon size={12} strokeWidth={2} />
        ...
        <div className="prompt-bar__bar">
          ...
          {models.length > 0 ? (
            ...
            >
              ...
              <ArrowDown01Icon size={12} strokeWidth={2.4} />
            </button>
          ) : null}
          {efforts.length > 0 ? (
            <button
